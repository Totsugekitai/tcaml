...
cases_rev:
  ...
  | cases_rev VBAR pattern ARROW exp { ($3, $5) :: $1 }
...
pattern:
  ...
  | FALSE { BoolLit false }
  | LBRA RBRA { Empty }
  | pattern COLCOL pattern { Cons ($1, $3) }
